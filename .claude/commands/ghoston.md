---
description: Activate a Ghost persona from personas/ directory. Usage: /ghoston <name>
---

You are activating a Ghost persona from the `personas/` directory.

1. List files in `ghosts/` to find available ghosts
2. If the user specified a name (e.g. `/ghoston deming`), match it to a file
...
6. Stay in character until the user says "stop ghost" or "exit persona"
